...
function main() {
  ...
  makeLabel(400, 100, 'T-box1', [-2, 0.5, 22]);
  ...
  makeLabel(400, 100, 'T-box2', [5, 0.5, 25]);
  ...
  {const geometry1 = new THREE.TetrahedronGeometry(1);
    ...
    cube1.castShadow = true;
    cube1.receiveShadow = true;
    cube1.position.set(-5, 1, 21);
    cube1.rotation.y = 10;
    scene.add(cube1);
    makeLabel(400,100,"tetrahedron", [-5, 1, 21])
  }
  ...
  makeLabel(400,100,"octahedron", [-8, 2, 18.5])
