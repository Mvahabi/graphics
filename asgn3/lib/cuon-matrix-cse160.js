...
class Vector3 {
    ...
    add(other) {
        ...
        for (let i = 0; i < 3; i++) {
          this.elements[i] += other.elements[i]; // Adds each vector 1 element to each vector 2 element
        }
    ...
    sub(other) {
        ...
        // This function should change this vector (this.elements) and not create a new vector.
        for (let i = 0; i < 3; i++) {
          this.elements[i] -= other.elements[i]; // Subtracts each vector 1 element from each vector 2 element
        }
        // Don't delete the return statement.
        return this;
    };
    ...
    div(scalar) {
        ...
        // This function should change this vector (this.elements) and not create a new vector.
        for (let i = 0; i < 3; i++) {
          this.elements[i] /= scalar; // Divides each vector element by the scalar
        }
        // Don't delete the return statement.
        return this;
    };
    ...
    mul(scalar) {
        ...
        // This function should change this vector (this.elements) and not create a new vector.
        for (let i = 0; i < 3; i++) {
          this.elements[i] *= scalar; // Multiplies each vector element to the scalar
        }
        // Don't delete the return statement.
        return this;
    };
    ...
    static dot(other1, other2) {
        ...
        // Formula of dot product: aÂ·b = sum of a[i] * b[i] for i = 1, 2
        for (let i = 0; i < 3; i++) {
    ...
    static cross(other1, other2) {
        ...
        // Formula to calculate cross product: A Ã— B = (bz â€“ cy)i â€“ (az â€“ cx)j + (ay â€“ bx)k 
    ...
    magnitude() {
        ...
        // Formula to calculate magnitude of v: |v| = âˆš(x^2 + y^2)
        for (let i = 0; i < 3; i++) {
    ...
    normalize() {
        ...
        // Divide each component by its magnitude to normalize vector
